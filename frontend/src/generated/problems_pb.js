...
goog.exportSymbol('proto.questions.Details', null, global);
 ...
 * @constructor
 */
proto.questions.Details = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.questions.Details.repeatedFields_, null);
};
goog.inherits(proto.questions.Details, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.questions.Details.displayName = 'proto.questions.Details';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.questions.Details.repeatedFields_ = [2,4];
 ...
 * @return {!Object}
 */
proto.questions.Details.prototype.toObject = function(opt_includeInstance) {
  return proto.questions.Details.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.questions.Details} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.questions.Details.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.questions.Details}
 */
proto.questions.Details.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.questions.Details;
  return proto.questions.Details.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.questions.Details} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.questions.Details}
 */
proto.questions.Details.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.questions.Details.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.questions.Details.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.questions.Details} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.questions.Details.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.questions.Details.prototype.getAnagramType = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.questions.Details} returns this
 */
proto.questions.Details.prototype.setAnagramType = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.questions.Details.prototype.getBlocksList = function() {
 ...
 * @return {!proto.questions.Details} returns this
*/
proto.questions.Details.prototype.setBlocksList = function(value) {
 ...
 * @return {!proto.questions.Block}
 */
proto.questions.Details.prototype.addBlocks = function(opt_value, opt_index) {
 ...
 * @return {!proto.questions.Details} returns this
 */
proto.questions.Details.prototype.clearBlocksList = function() {
 ...
 * @return {string}
 */
proto.questions.Details.prototype.getSolution = function() {
 ...
 * @return {!proto.questions.Details} returns this
 */
proto.questions.Details.prototype.setSolution = function(value) {
 ...
 */
proto.questions.Details.prototype.getOptionsList = function() {
  return /** @type{!Array<!proto.questions.Option>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.questions.Option, 4));
};
 ...
 * @return {!proto.questions.Details} returns this
*/
proto.questions.Details.prototype.setOptionsList = function(value) {
 ...
 * @return {!proto.questions.Option}
 */
proto.questions.Details.prototype.addOptions = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.questions.Option, opt_index);
};
 ...
 * @return {!proto.questions.Details} returns this
 */
proto.questions.Details.prototype.clearOptionsList = function() {
...
proto.questions.Question.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    details: (f = msg.getDetails()) && proto.questions.Details.toObject(includeInstance, f)
  };
...
proto.questions.Question.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.questions.Details;
      reader.readMessage(value,proto.questions.Details.deserializeBinaryFromReader);
...
proto.questions.Question.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.questions.Details.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional Details details = 5;
 * @return {?proto.questions.Details}
 */
proto.questions.Question.prototype.getDetails = function() {
  return /** @type{?proto.questions.Details} */ (
    jspb.Message.getWrapperField(this, proto.questions.Details, 5));
};


/**
 * @param {?proto.questions.Details|undefined} value
 * @return {!proto.questions.Question} returns this
*/
proto.questions.Question.prototype.setDetails = function(value) {
 ...
 * @return {!proto.questions.Question} returns this
 */
proto.questions.Question.prototype.clearDetails = function() {
 ...
 * @return {boolean}
 */
proto.questions.Question.prototype.hasDetails = function() {
